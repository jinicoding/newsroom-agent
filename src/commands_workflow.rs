...
pub(crate) fn format_date_from_epoch(secs: u64) -> String {
...
pub(crate) fn datetime_to_epoch(datetime: &str) -> Option<u64> {
...
// ── /desk, /collaborate, /coverage — extracted to commands_editorial.rs ──
pub use crate::commands_editorial::{
    handle_collaborate, handle_coverage, handle_desk,
    // Types & utilities used by dashboard, morning, recap, etc.
    CollabProject, CollabStatus, CoverageClaim, DeskAssignment, DeskStatus,
    COLLABORATE_DIR, coverage_path, desk_path, list_collab_projects_in, load_coverage_from,
    load_desk_from,
};
#[cfg(test)]
pub use crate::commands_editorial::{save_collab_project_to, save_coverage_to, save_desk_to};
...
pub(crate) fn day_of_week(date: &str) -> Option<u32> {
...
// ── /story — extracted to commands_story.rs ─────────────────────────────
pub use crate::commands_story::{
    extract_story_arg, handle_story, link_file_to_story, STORIES_DIR, STORY_SUBCOMMANDS,
};
#[cfg(test)]
...
pub use crate::commands_foia::{handle_foia, FOIA_SUBCOMMANDS};

// ── /series — extracted to commands_series.rs ─────────────────────────
pub use crate::commands_series::{handle_series, SERIES_SUBCOMMANDS};
