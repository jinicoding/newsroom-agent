...
//! Commands: /autopitch, /breaking, /briefing, /calendar, /collaborate, /compare, /coverage, /dashboard, /data, /deadline, /desk, /diary, /embargo, /foia, /interview, /morning, /performance, /pitch, /recap, /rival, /story, /timeline
...
fn handle_foia_update_cmd(args: &str) {
    ...
    println!(
        "{GREEN}  ✅ #{id} 상태 변경: {old_status} → {new_status}{RESET}"
    );
    if new_status == "연장" {
